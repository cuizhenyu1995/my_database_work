        ...
        url: "/online/index/get_gmsb/", //请求后台的URL（*）
        method: 'get', //请求方式（*）
        toolbar: '#toolbar',
        ...
        uniqueId: "buy_no", //每一行的唯一标识，一般为主键列
...
//            alert(yy);
            ...
            $.post("/online/index/add_gmsb/",{

                'buy_no' : "0",
                'de_no' : document.getElementById("sbbh").value,
                'de_btime' : document.getElementById("gmsj").value,
                'de_ptime' : document.getElementById("scsj").value,
                'buy_num' : document.getElementById("gmsl").value,
